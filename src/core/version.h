...
const uint32_t APP_VERSION_MINOR = 1;
...
const uint32_t ARCHIVE_VERSION_MINOR = 1;
...
const uint32_t MAX_SUPPORTED_ARCHIVE_VERSION_MINOR = 1;
...
const uint32_t MIN_SUPPORTED_ARCHIVE_VERSION_MINOR = 1;
